/* Original JS from miki.noriks.com/ortostep - pixel-perfect copy */
  ...
  async function recalculatePrices(){
    ...
    function setLinkDynamicCart(quantity = null) {
      ...
      for(const addToCartButton of addToCartButtons){
        addToCartButton.href = "https://si.stepease.eu/kosarica/?add-more=" + linkIdsString + dynPriceParam;
      }
            ...
            function regenerateCartLink({type = null, quantity, subscriptionDuration, subscriptionDiscount}) {
              ...
              switch(type){
                case 'quantityPicker': {
                  ...
                  const link = "https://si.stepease.eu?add-more=" + products;
                  //post purchase add to cart
                  const postPurchaseLink =  "https://si.stepease.eu?add-more-lp=" + products +
...
function submitproductform() {document.getElementById("0-hs-cf-add-to-cart").click();}

/* bottomStickyBar — sticky bar that appears after 20% of the scroll */
/* ========================================================================== */
...
(function() {
    // Override the original add-to-cart behavior to use WooCommerce
    var originalSetup = window.addEventListener;
        ...
        setTimeout(function() {
            ...
            for (var i = 0; i < addToCartButtons.length; i++) {
                addToCartButtons[i].addEventListener('click', function(e) {
                    ...
                    // Get selected variation from the page's JS variables
                    var form = document.getElementById('wc-add-to-cart-form');
                    if (!form) return;
                    
                    // Try to get variation ID from the original page's variationsArr
                    if (typeof variationsArr !== 'undefined' && typeof propertiesArr !== 'undefined') {
                        ...
                        if (matchedVariation && matchedVariation.variationId) {
                            document.getElementById('wc-variation-id').value = matchedVariation.variationId;
                        }
                    }
                    
                    // Get quantity
                    var qtyInput = document.querySelector('.quantity-selector__input, [name="quantity"]');
                    if (qtyInput) {
                        document.getElementById('wc-quantity').value = qtyInput.value || 1;
                    }
